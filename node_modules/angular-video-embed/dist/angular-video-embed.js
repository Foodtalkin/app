...
var Video = (function () {
    ...
    Video.prototype.bindTo = function (htmlId) {
    };
...
var Player = (function () {
    function Player(video) {
        var _this = this;
        this.video = video;
        this.onLibraryLoaded = function ($q) {
            var waitTimeMax = 3000;
            var waitInterval = 100;
            var waitedFor = 0;
            return $q(function (resolve, reject) {
                var wait = function () {
                    if (waitedFor >= waitTimeMax) {
                        reject("Library for " + _this.video.service + " did not load");
                        return false;
                    }
                    if (_this.isLibraryLoaded()) {
                        resolve();
                        return true;
                    }
        ...
        this.firePlayed = function (event) {
            _this.fireCallbacks(_this.callbacks.played);
        };
        this.fireReady = function (event) {
            _this.fireCallbacks(_this.callbacks.ready);
        };
        this.firePaused = function (event) {
            _this.fireCallbacks(_this.callbacks.paused);
        };
        this.fireEnded = function (event) {
            _this.fireCallbacks(_this.callbacks.ended);
        };
        this.fireBuffering = function (event) {
            _this.fireCallbacks(_this.callbacks.buffering);
        };
        this.callbacks = {
            ready: [],
            played: [],
    ...
    Player.prototype.fireCallbacks = function (cbs) {
        var _this = this;
    ...
    Player.prototype.onPlayed = function (callback) {
        if (_.isFunction(callback)) {
    ...
    Player.prototype.onBuffering = function (callback) {
        if (_.isFunction(callback)) {
            this.callbacks.buffering.push(callback);
        }
    };
    Player.prototype.onPaused = function (callback) {
        if (_.isFunction(callback)) {
        ...
        return {
            ...
            link: function ($scope, $el) {
                function init() {
                    ...
                    defineListeners();
                    $timeout(function () { return bindPlayer($scope.video); });
                }
                ...
                function createPlayer(video) {
                    if (video) {
                        switch (video.service) {
                            case "youtube":
                                return new YouTubePlayer_1.YouTubePlayer(video);
                            case "vimeo":
                                return new VimeoPlayer_1.VimeoPlayer(video);
                            case "viddler":
                                return new ViddlerPlayer_1.ViddlerPlayer(video);
                        }
                    }
                    return null;
                }
...
Object.defineProperty(exports, "__esModule", { value: true });
var ViddlerVideo_1 = __webpack_require__(4);
var VimeoVideo_1 = __webpack_require__(5);
var YouTubeVideo_1 = __webpack_require__(6);
...
var YouTubePlayer = (function (_super) {
    ...
    function YouTubePlayer(video) {
        ...
        _this.video = video;
        _this.fireStateChange = function (event) {
            switch (event.data) {
                case YT.PlayerState.ENDED:
                    return _this.fireEnded(event);
                case YT.PlayerState.PLAYING:
                    return _this.firePlayed(event);
                case YT.PlayerState.PAUSED:
                    return _this.firePaused(event);
                case YT.PlayerState.BUFFERING:
                    return _this.fireBuffering(event);
            }
        };
        return _this;
    }
    YouTubePlayer.prototype.isLibraryLoaded = function () {
        return typeof YT !== 'undefined' && !!YT.loaded;
    };
    YouTubePlayer.prototype.getLibrary = function () {
        return YT;
    };
    YouTubePlayer.prototype.bind = function ($q) {
        var _this = this;
        return this.onLibraryLoaded($q).then(function () {
            ...
            _this.player = new lib.Player(_this.video.toString(), {
                ...
                width: "100%",
                events: {
                    'onReady': _this.fireReady,
                    'onStateChange': _this.fireStateChange
                }
            });
            return _this;
        });
...
var path = '/angular-video-embed/src/index.html';
